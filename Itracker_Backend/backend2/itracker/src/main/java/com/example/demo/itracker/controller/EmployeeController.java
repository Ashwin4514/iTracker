...
public class EmployeeController {
	...
	private EmployeeSkillsServiceImpl employeeSkillsServiceimpl;
	...
	@GetMapping("e_id/{email}")
	public List<EmployeeSkill> getSkillsbyEmail(@PathVariable String email){
		return employeeSkillsServiceimpl.getSkillsByEmployeeEmail(email);
	}
